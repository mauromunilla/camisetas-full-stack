...
<div class="container tablaTalles">
    <div class="row">
        <div class="list-group list-group-horizontal col-lg-fluid" id="list-tab" role="tablist">
            @foreach (['1' => 'Hombre', '2' => 'Mujer', '3' => 'Niños'] as $categoria_id => $categoria_nombre)
    ...
    <div class="tab-content" id="nav-tabContent">
        @foreach (['1' => 'Hombre', '2' => 'Mujer', '3' => 'Niños'] as $categoria_id => $categoria_nombre)
            <div class="tab-pane fade @if ($loop->first) show active @endif" 
                ...
                <h3>Medidas de camiseta para {{ strtolower($categoria_nombre) }}</h3>
...
<div class="text-center my-4">
    <img src="images/guia-de-talles.webp" class="img-fluid hover-zoom" alt="Guía de Talles">
</div>
